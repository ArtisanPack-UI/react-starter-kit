...
3. Create `resources/js/pages/Reports.tsx`:
...
4. Optional: add a sidebar entry in `resources/js/layouts/AppLayout.tsx`'s `NAV` array.
...
- [Components](components.md) — what's available in `@artisanpack-ui/react`
